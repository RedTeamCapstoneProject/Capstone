...
${bullets}`;
  ...
  var import_jquery, import_util, categories, FALLBACK_IMAGE_SRC;
  var init_main = __esm({
    "assets/ts/main.ts"() {
      "use strict";
      ...
      FALLBACK_IMAGE_SRC = "images/pic01.jpg";
      (function($) {
  ...
  var require_single = __commonJS({
    "assets/ts/single.ts"() {
      ...
      (function() {
        ...
        style.textContent = '.article-tab-panel { display: none; } .article-tab-panel.active { display: block; } .article-tabs-nav { display: flex; align-items: center; } .article-tabs-nav .article-tab[data-action="report"] { margin-left: auto; } .report-form { display: block; } .report-label { display: block; margin-bottom: 0.6em; letter-spacing: 0.12em; text-transform: uppercase; font-size: 0.75em; font-weight: 700; color: #6a6a6a; } .report-form textarea { min-height: 10.5em; resize: vertical; margin-bottom: 0.65em; } .report-form-footer { display: flex; align-items: center; justify-content: space-between; gap: 0.8em; } .report-counter { color: #8a8a8a; font-size: 0.8em; letter-spacing: 0.02em; } body.single #main article.post > header .meta { border-left: 0; display: flex; align-items: center; justify-content: center; text-align: center; } body.single #main article.post > header .meta .published { margin-top: 0; white-space: normal; line-height: 1.45; }';
